 ...
 * <ul>
 * <li> `browser:uncompressed` - build uncomprssed browser bundle (`btcnano-*.js`)
 * <li> `browser:compressed` - build compressed browser bundle (`btcnano-*.min.js`)
...
function startGulp(name, opts) {
  ...
  var fullname = name ? 'btcnano-' + name : 'btcnano';
  var files = ['lib/**/*.js'];
  var tests = ['test/**/*.js'];
  var alljs = files.concat(tests);

  var buildPath = './node_modules/btcnano-build/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = browserifyPath + ' --require ./index.js:' + fullname + ' --external btcnano-lib -o ' + fullname + '.js';
    } else {
      browserifyCommand = browserifyPath + ' --require ./index.js:btcnano-lib -o btcnano-lib.js';
    }
